...
{
	struct page_walker walker = {
		.get_pde = lab2_do_check_ptbl_flags,
		.get_pdpte = lab2_do_check_ptbl_flags,
		.get_pml4e = lab2_do_check_ptbl_flags,
	};
...
{
	struct page_walker walker = {
		.get_pte = lab2_check_pte_wx,
		.get_pde = lab2_check_pde_wx,
	};
...
{
	struct page_walker walker = {
		.get_pte = lab2_check_pte_vas,
		.get_pde = lab2_check_pde_vas,
	};
